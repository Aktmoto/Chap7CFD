...
one7_3 = NonCnsvMacCormack.sub_superOneStep(deltax,
                            1,
                            pointLength,
                            ρ7_3,
                            v7_3,
...
totalResult7_3 = Vector{NonCnsvMacCormack.PrimitiveValuesWithStepNum}()
push!(totalResult7_3,one7_3)
totalStep7_3 = 1400
let
    prev = one7_3
...
graphMaker.makeMultiLineGraph(x7_5,"位置","流量","7_5massFlowConvergence",(totalResult7_5[1].u2,"0Δt")),(totalResult7_5[400].u2,"400Δt"),(totalResult7_5[800].u2,"800Δt"),(totalResult7_5[1200].u2,"1200Δt")
#正確値の表示のための設定
exact_u2 = [specific_U2 for i in 1:1:pointLength]
#保存非保存の比較
...
v7_6 = velocity7_6(specific_U2,A7_6,ρ7_6)
...
graphMaker.makeMultiLineGraph(x7_6, "位置","圧力","7_6pressure",(totalResult7_6_Cx1[totalStep7_6].primitive.p,"Cx=0.0"),(totalResult7_6_Cx2[totalStep7_6].primitive.p,"Cx=0.1"),(totalResult7_6_Cx3[totalStep7_6].primitive.p,"Cx=0.2"),(totalResult7_6_Cx4[totalStep7_6].primitive.p,"Cx=0.3"))
